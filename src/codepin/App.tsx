...
import font from "../res/font/Poppins-Regular.ttf";
    ...
    return (
        <Box dir="column" align={left ? 'flex-start' : 'flex-end'} justify="flex-start" width="100%" height="auto" minHeight="100%">
            ...
            <Box marginLeft={1.5} marginRight={1.5} marginTop={2}>
                <Text font={font} position={[left ? 1 : -1, 0.5, 1]} fontSize={textScaleFactor} lineHeight={1} letterSpacing={-0.05} maxWidth={(viewport.width / 4) * 3}>
                    {tag}
